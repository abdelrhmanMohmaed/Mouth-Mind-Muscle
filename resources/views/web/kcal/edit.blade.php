        ...
        <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fa fa-calculator" aria-hidden="true"></i> &nbsp;Update Input Calculation <span
                            id="title"></span>
                    </h3>
                </div>

                @include('web.kcal.inc.inputsTotalEdit')
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10">
                        ...
                        <div class="col-md-10">
                            <form class="row" action="{{ route('kcal.update') }}" method="POST">
                                @csrf
                                ...
                                @forelse ($kcals as $item)
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="number" id="result_kcal_{{ @$item->id }}"
                                                    step="any" class="form-control " placeholder="0" required=""
                                                    disabled>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->milk_s}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->milk_l}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->milk_f}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->vegetable}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->fruit}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->starch}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->proteins_l}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->proteins_m}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->proteins_h}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->fat}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->halfstlmfat_s}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->halfstlmfat_a}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->stlmfat_p}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->stlmfat_f}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->beverages}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->alcohol}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->cho}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->miscellaneous}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" value="{{$inputCal->supplements}}"  class="form-control bg-warning" disabled>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
